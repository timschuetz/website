...
I’m an active member of the Design Group for the Platform for Experimental Collaborative Ethnography (PECE). I’ve helped develop a series of PECE-supported projects, consulted for research groups, and currently serve as open data editor for ([Engaging Science, Technology, and Society.](https://estsjournal.org/index.php/ests)).
